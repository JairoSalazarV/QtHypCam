...
#define LSTPATHS_H
    ...
    #define _PATH_LIMIT_R                           "rightlimit.hypcam"
    #define _PATH_LIMIT_U                           "upperlimit.hypcam"
    #define _PATH_LIMIT_L                           "leftlimit.hypcam"
    #define _PATH_LIMIT_D                           "lowerlimit.hypcam"
    #define _PATH_LIMIT_S_HALOGEN                   "hs.hypcam"
    #define _PATH_LIMIT_S_FLUORESCENT               "fs.hypcam"
