...
strLimits genCalibXML::getLimitsFromHDD(){
    ...
    else
    {
        ...
        //qDebug() << "Aquí7.1.3.1-> 6 -> X: " << limits.sourceX << " Y: " << limits.sourceY;
    }
